...
## Development Roadmap — By Condition
...
# ── Weekly aggregation for epicurves ─────────────────────────────────────────
...
# Recode province codes to full names for display in legends and filters
prov_labels <- c(
...
weekly[, Province := prov_labels[Province]]
...
hotspots[, Province := prov_labels[Province]]
...
```{r}
#| label: fig-epicurve
#| fig-cap: "Weekly case counts stacked by province — use the filter above to select a condition"
...
plot_ly(sd_weekly, x = ~Week, y = ~incidence_100k, color = ~Province,
        ...
        hoverinfo = "text",
        text = ~paste0(Province, " — ", format(Week, "%d %b %Y"),
...
::: {.callout-tip}
## Related Sections
- [By Province](../by-province/index.html) — province-first view with district drilldown
...
- [Methods](../methods.html) — indicator definitions and data sources
:::
