...
# PROV_CODE and PROV_NAME must be set by the parent stub before knit_child()
stopifnot(exists("PROV_CODE"), exists("PROV_NAME"))
...
cats_present <- cats_present[cats_present > 0]
```
